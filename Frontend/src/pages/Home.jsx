           ...
           <nav className="purple-nav">
                ...
                <div className="row h-100">
                    <div className="col-6 nav-left my-auto">
                        <img className="logo" src={logo_transformed} alt="scribble logo"/>
                    </div>
            ...
            <div className="main-home">
                <div className="center intro">
                    ...
                    <button className="dark-button">Open Scribble in your browser</button>
                </div>        
            </div>
                ...
                <div className="container the-container">
                    <div className="row h-100">
                        <div className="col-6 disp-left-1 .text-center my-auto">
                            <h1>Who We Are</h1>
                            <p>At Scribble, we are passionate about helping grade school
                            and college students across the globe succeed in their studies. 
                            Our application blends the best of online chat and note-taking to provide a
                            seamless learning and collaboration experience for students. 
                            No more having multiple apps open when working - everything you need is right here.
                            </p>
                            <h1>Our Team</h1>
                ...
                <div className="container the-container">
                    <div className="row h-100">
                        <div className="col-6 disp-left-2 .text-center my-auto">
                            ...
                            <p>Scribble contains a chat room for every class you're taking, 
                            where you can touch base with your peers on anything from last 
                            week's midterm to upcoming projects.</p>
                        </div>
                ...
                <div className="container the-container">
                    <div className="row h-100">
                        ...
                        <div className="col-6 disp-right-3 .text-center my-auto">
                            ...
                            <p>Upload and create notes for your classes so you will never miss a
                            beat when studying.</p>
                        </div>
                    </div>
                </div>
            </div>
