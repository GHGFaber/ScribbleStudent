...
function UserProfile({isActive, callback}) {
    let userData = [];
                    ...
                    <Modal
                        ...
                        <Box id="user-profile-box">
                            <div className="user-profile-content">
                                ...
                                <p>{userData[0].userType} at {userData[0].schoolName}</p>
                                <h5>My Classes</h5>
                                <ul>
                                    {
                                ...
                                <button type="button" className="edit-profile-button" onClick={userUpdate}>Edit Profile</button>
                                <button type="button" onClick={() => close_user_profile()} className="back-button">Back</button>
                            </div> 
                        </Box>            
                    </Modal> 
                )}              
